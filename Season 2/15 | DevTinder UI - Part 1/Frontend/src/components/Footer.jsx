        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex flex-col items-center justify-center gap-0 sm:justify-start">
              ...
              <p className="text-textMuted max-w-md text-justify leading-relaxed sm:mx-0 sm:max-w-xs">
                  ...
                  return (
                    <li key={link}>
                      <a
                        ...
                        target="_blank"
                        className="hover:text-hover text-primary transition hover:cursor-pointer"
                      >
                        <span className="sr-only">{link}</span>
                        <span className="text-text bg-hover flex size-10 items-center justify-center rounded-full hover:scale-110">
                          {SOCIAL_LINKS[link][1]}
                        </span>
                      </a>
                    </li>
                    ...
                    <ul className="space-y-4 text-sm">
                      {FOOTER_SECTIONS[section].map((link) => {
                        return (
                          <li>
                            <a
                              className="hover:text-textMuted transition"
              ...
              <ul className="mt-4 space-y-4 text-sm">
                <li>
                  ...
                  >
                    ...
                    <span className="group-hover:text-textMuted transition">
                      devroot@gmail.com
                    </span>
                  </a>
                </li>
                ...
                <li className="group flex items-start justify-center gap-1.5 sm:justify-start">
                  ...
                  <address className="group-hover:text-textMuted -mt-0.5 not-italic transition hover:cursor-pointer">
        ...
        <div className="mt-6 border-t border-gray-800 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="space-x-2 text-sm text-gray-400">
              ...
              <a
                className="text-hover hover:text-hover inline-block underline transition hover:opacity-75"
                href="/"
              >
                Terms & Conditions
              </a>
